...
if (is_null(dcCore::app()->blog->settings->socialShare->active)) {
    try {
        ...
        dcCore::app()->blog->settings->socialShare->put('active', false, 'boolean', 'Active', false);

        dcCore::app()->blog->settings->socialShare->put('twitter', true, 'boolean', 'Add Twitter button', false);
        dcCore::app()->blog->settings->socialShare->put('facebook', true, 'boolean', 'Add Facebook button', false);
        dcCore::app()->blog->settings->socialShare->put('linkedin', true, 'boolean', 'Add LinkedIn button', false);
        dcCore::app()->blog->settings->socialShare->put('mastodon', true, 'boolean', 'Add Mastodon button', false);
        dcCore::app()->blog->settings->socialShare->put('mail', true, 'boolean', 'Add mail button', false);

        dcCore::app()->blog->settings->socialShare->put('on_post', true, 'boolean', 'Add social sharing buttons on post', false);
        dcCore::app()->blog->settings->socialShare->put('on_page', false, 'boolean', 'Add social sharing buttons on page', false);

        dcCore::app()->blog->settings->socialShare->put('on_single_only', true, 'boolean', 'Display social sharing buttons on single display only (post or page)', false);

        dcCore::app()->blog->settings->socialShare->put('before_content', false, 'boolean', 'Display social sharing buttons before content', false);
        dcCore::app()->blog->settings->socialShare->put('after_content', true, 'boolean', 'Display social sharing buttons after content', false);
        dcCore::app()->blog->settings->socialShare->put('template_tag', false, 'boolean', 'Display social sharing buttons using template tag', false);

        dcCore::app()->blog->settings->socialShare->put('prefix', __('Share this entry:'), 'string', 'Social sharing buttons prefix text', false);
        dcCore::app()->blog->settings->socialShare->put('intro', '', 'string', 'Title introduction text', false);
        dcCore::app()->blog->settings->socialShare->put('tags', true, 'boolean', 'Use tags if any', false);
        dcCore::app()->blog->settings->socialShare->put('use_style', 0, 'integer', 'CSS style used', false);
        dcCore::app()->blog->settings->socialShare->put('style', '', 'string', 'Social sharing buttons style', false);
...
$ssb_active = (bool) dcCore::app()->blog->settings->socialShare->active;

$ssb_twitter  = (bool) dcCore::app()->blog->settings->socialShare->twitter;
$ssb_facebook = (bool) dcCore::app()->blog->settings->socialShare->facebook;
$ssb_linkedin = (bool) dcCore::app()->blog->settings->socialShare->linkedin;
$ssb_mastodon = (bool) dcCore::app()->blog->settings->socialShare->mastodon;
$ssb_mail     = (bool) dcCore::app()->blog->settings->socialShare->mail;

$ssb_on_post = (bool) dcCore::app()->blog->settings->socialShare->on_post;
$ssb_on_page = (bool) dcCore::app()->blog->settings->socialShare->on_page;

$ssb_on_single_only = (bool) dcCore::app()->blog->settings->socialShare->on_single_only;

$ssb_before_content = (bool) dcCore::app()->blog->settings->socialShare->before_content;
$ssb_after_content  = (bool) dcCore::app()->blog->settings->socialShare->after_content;
$ssb_template_tag   = (bool) dcCore::app()->blog->settings->socialShare->template_tag;

$ssb_prefix    = dcCore::app()->blog->settings->socialShare->prefix;
$ssb_intro     = dcCore::app()->blog->settings->socialShare->intro;
$ssb_tags      = (bool) dcCore::app()->blog->settings->socialShare->tags;
$ssb_use_style = (int) dcCore::app()->blog->settings->socialShare->use_style;
$ssb_style     = dcCore::app()->blog->settings->socialShare->style;

$ssb_twitter_account = dcCore::app()->blog->settings->socialShare->twitter_account;
...
if (!empty($_POST)) {
    try {
        ...
        dcCore::app()->blog->settings->socialShare->put('twitter', $ssb_twitter);
        dcCore::app()->blog->settings->socialShare->put('facebook', $ssb_facebook);
        dcCore::app()->blog->settings->socialShare->put('linkedin', $ssb_linkedin);
        dcCore::app()->blog->settings->socialShare->put('mastodon', $ssb_mastodon);
        dcCore::app()->blog->settings->socialShare->put('mail', $ssb_mail);

        dcCore::app()->blog->settings->socialShare->put('on_post', $ssb_on_post);
        dcCore::app()->blog->settings->socialShare->put('on_page', $ssb_on_page);

        dcCore::app()->blog->settings->socialShare->put('on_single_only', $ssb_on_single_only);

        dcCore::app()->blog->settings->socialShare->put('before_content', $ssb_before_content);
        dcCore::app()->blog->settings->socialShare->put('after_content', $ssb_after_content);
        dcCore::app()->blog->settings->socialShare->put('template_tag', $ssb_template_tag);

        dcCore::app()->blog->settings->socialShare->put('prefix', $ssb_prefix);
        dcCore::app()->blog->settings->socialShare->put('intro', $ssb_intro);
        dcCore::app()->blog->settings->socialShare->put('tags', $ssb_tags);
        dcCore::app()->blog->settings->socialShare->put('use_style', $ssb_use_style);
        dcCore::app()->blog->settings->socialShare->put('style', $ssb_style);

        dcCore::app()->blog->settings->socialShare->put('twitter_account', $ssb_twitter_account);
